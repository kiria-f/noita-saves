...
1. Выйди из игры
2. **Дождись окончания синхронизации Steam**, если она включена
3. Открой NoitaSaves
4. Введи `l <индекс сейва>` или просто `l`, чтобы выбрать последний

### Чтобы удалить сейв:

1. Открой NoitaSaves
2. Введи `d <индекс или диапазон сейвов>`
